...
import { ITEMS } from '../../livrejam/src/game/config';
...
const scenario = [
    ...
    { index: 8, x: 250, y: 200, vx: -20, vy: 240, spin: 0, roll: 0.75 },
    { index: 24, x: 430, y: 260, vx: 0, vy: 140, spin: 0, roll: 0.5 },
    { index: 3, x: 70, y: 90, vx: 15, vy: 300, spin: 0, roll: 0.4 },
    { index: 15, x: 560, y: 40, vx: -5, vy: 260, spin: 0, roll: 0.9 },
    { index: 20, x: 120, y: 320, vx: 0, vy: 90, spin: 0, roll: 0.1 },
    { index: 11, x: 500, y: 180, vx: 8, vy: 200, spin: 0, roll: 0.6 },
];
