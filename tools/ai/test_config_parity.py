...
PAIRS = (
    ...
    ("dodger.jumpCutMultiplier", cfg.JUMP_CUT_MULTIPLIER, "dodger.jumpCutMultiplier"),
    ("dodger.fastFallSpeed", cfg.FAST_FALL_SPEED, "dodger.fastFallSpeed"),
    ("dodger.fastFallBoost", cfg.FAST_FALL_BOOST, "dodger.fastFallBoost"),
    ...
    ("itemDash.speed", cfg.ITEM_DASH_SPEED, "itemDash.speed"),
    ("itemDash.seconds", cfg.ITEM_DASH_SECONDS, "itemDash.seconds"),
    ("itemDash.spinBoost", cfg.ITEM_DASH_SPIN_BOOST, "itemDash.spinBoost"),
