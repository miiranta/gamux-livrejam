...
export const ITEMS: readonly ItemDefinition[] = [
    ...
    {
        key: 'anvil',
        sprite: 'assets/items/tile-0065.png',
        damage: { min: 18.0, max: 38.0 },
        weight: 7.0,
        half: { width: 15.0, height: 15.0 },
        spin: { min: 3.4, max: 7.0 },
        restitution: 0.28,
        angularDamping: 5.2,
        linearDamping: 5.0,
    },
    {
        key: 'chest',
        sprite: 'assets/items/tile-0090.png',
        damage: { min: 20.0, max: 42.0 },
        weight: 6.0,
        half: { width: 17.0, height: 17.0 },
        spin: { min: 3.0, max: 6.2 },
        restitution: 0.24,
        angularDamping: 5.4,
        linearDamping: 5.0,
    },
